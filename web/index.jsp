        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="./ServletPrincipal?op=Carro"><i class="fas fa-cart-arrow-down" style="height: 30px;">(<label
                                    style="color:red;">${cont}</label>)</i>Carrito De Compras </a>
                    </li>
                   ...
                   <c:forEach var="p" items="${productos}">     
                            <div class="card cardp">
                                ...
                                <div class="cont_button">
                                    <a href="ServletPrincipal?op=AgregarCarro&id=${p.getId()}" id="btnAddCar">Agregar al
                                        Carrito</a>
                                    <a href="" id="btnGoCar">Ir Carro</a>
                                </div>
                            </div>
