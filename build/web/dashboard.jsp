            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="./ServletPrincipal?op=GuardarProducto" method="POST" enctype='multipart/form-data'>
                                ...
                                <div class="form-group">
                                    <button  class="btn btn-danger" name="op" value="GuardarProducto">Guardar</button>
                                    <button  class="btn btn-success" name="op" value="actualizar">Actualizar</button>
                                </div>
                            </form>
                        </div>               
                    </div>
